...
(C) HexNet Studios / Miller Hollinger
...
Warning: There is a reported issue where clicking on the text area breaks auto-scroll.
  So, please avoid clicking the text area. The text entry bar is safe as well as the normal scroll bar.
